...
public class SpecialItem extends Item {
	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
		playerIn.addPotionEffect(new EffectInstance(Effects.HASTE, 2000, 100));
		ZombieEntity Entity =  new ZombieEntity(worldIn);
		worldIn.addEntity(new ZombieEntity(worldIn));
		Entity.setPosition(playerIn.getPosX() + 5, playerIn.getPosY() - 5, playerIn.getPosZ() + 5);
