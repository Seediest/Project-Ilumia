...
*/
 static ResourceLocation ourTexture = new ResourceLocation("illumidoggies_mod:items/test_helmet.png");
 ...
 */
     ...
     //THIS SHIT MIGHT BE IMPORTANT BUT I COMMENTED IT OUT CUZ IT DIDNT WORK LOL LOLOLOL ------------------------------------------------
 ...
 */
 ...
 // Just use what BlockBench gives you for the render method
     ...
     public void render(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
         myHatPart1.render(matrixStack, buffer, packedOverlay, packedOverlay);
         myHatPart2.render(matrixStack, buffer, packedOverlay, packedOverlay);
     }
